  ...
  return (
    <div>
      ...
      <div className="hidden sm:block w-max h-screen bg-primary-dark">
        ...
        <div className="mt-4">
          <li className="flex hover:bg-primary-lite cursor-pointer list-none border-b-2 p-2 text-2xl font-semibold text-center tracking-wider border-gray-600">
          ...
          <li className="list-none hover:bg-primary-lite cursor-pointer border-b-2 p-2 text-2xl font-semibold text-center tracking-wider border-gray-600">
          ...
          <li className="list-none hover:bg-primary-lite border-b-2 p-2 text-2xl font-semibold text-center tracking-wider border-gray-600">
          ...
          <li
            className="list-none border-b-2 hover:bg-primary-lite p-2 text-2xl font-semibold text-center tracking-wider border-gray-600"
            onClick={() => {
