...
const ProgressBar: React.FC<Props> = ({
  ...
  return (
    <div
      className={` p-2 border-2 hover:shadow-stacked cursor-pointer transform  transition-ease duration-700 hover:scale-95 rounded-md border-primary-lite flex flex-col ${height} ${width} ${className}`}
    >
